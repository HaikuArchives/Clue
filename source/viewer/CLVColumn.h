...
enum
{
	...
	CLV_ALIGN_LEFT = 			0x00001000,		//Align text along the left side of the column
	CLV_ALIGN_CENTER = 			0x00002000,		//Align text in the center of the column
	CLV_ALIGN_RIGHT = 			0x00004000		//Algin text along the right side of the column
};
