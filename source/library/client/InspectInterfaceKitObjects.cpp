	...
	)
{
	...
	char hexbuf[12];
	GetHexString (hexbuf, (int32) inValue);
	strDetails << tabindent << pDescription << "[BOptionPopUp object, ptr=" << hexbuf << "]\n";
	tabindent << g_pIndentation;
	...
	{
		strDetails << tabindent << "The BOptionPopUp was NULL\n";
	}
}
#endif
	...
	)
{
	...
	char hexbuf[12];
	GetHexString (hexbuf, (int32) inValue);
	strDetails << tabindent << pDescription << "[BOptionControl object, ptr=" << hexbuf << "]\n";
	tabindent << g_pIndentation;
	...
	{
		strDetails << tabindent << "The BOptionControl was NULL\n";
	}
}
#endif
	...
	)
{
	...
	char hexbuf[12];
	GetHexString (hexbuf, (int32) inValue);
	strDetails << tabindent << pDescription << "[BChannelSlider object, ptr=" << hexbuf << "]\n";
	tabindent << g_pIndentation;
	...
	{
		strDetails << tabindent << "The BChannelSlider was NULL\n";
	}
}
#endif
	...
	)
{
	...
	char hexbuf[12];
	GetHexString (hexbuf, (int32) inValue);
	strDetails << tabindent << pDescription << "[BChannelControl object, ptr=" << hexbuf << "]\n";
	tabindent << g_pIndentation;
	...
	{
		strDetails << tabindent << "The BChannelControl was NULL\n";
	}
}
#endif
